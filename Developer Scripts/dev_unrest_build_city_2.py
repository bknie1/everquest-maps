...
import sys, math
from eqmap_toolkit import Canvas, frame, title, compass, title_band_knockout, skull_motif
...
THEMES={
 ...
 'haunted':dict(OUT=(64,70,64), INN=(120,128,110), GC=(120,124,112), TC=(70,84,72), SH=(120,128,110)),    # stonebrunt
}
T=THEMES[THEME]
def parse(path):
    L=[]
...
_ctr = skull_motif if THEME=='haunted' else None
compass(cv, cv.bx0+bc, cv.by1-bc, CR, ring=(T['OUT'],T['INN']), rose=(T['INN'],T['GC']), center=_ctr, center_colors=((60,66,58),(150,150,140)), label=T['OUT'], n_label=T['TC'], arrow=T['TC'])
