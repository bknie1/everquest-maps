...
THEMES={
 ...
 'mtn':    dict(OUT=(90,84,74), INN=(150,150,140), GC=(160,158,150), TC=(80,76,68), SH=(150,150,140)),    # stonebrunt
 'plains': dict(OUT=(96,110,70), INN=(150,168,110), GC=(160,165,140), TC=(90,110,66), SH=(150,168,110)),   # karana grassland
 'sewer':  dict(OUT=(58,74,42), INN=(120,140,80), GC=(130,140,110), TC=(70,90,50), SH=(120,140,80)),       # qeynos aqueduct
 'den':    dict(OUT=(96,78,54), INN=(160,132,90), GC=(160,150,130), TC=(110,86,56), SH=(160,132,90)),      # rocky gorge
 'gothic': dict(OUT=(70,66,72), INN=(140,134,120), GC=(150,146,140), TC=(80,76,80), SH=(140,134,120)),     # high keep castle
 'ocean':  dict(OUT=(40,80,110), INN=(110,170,200), GC=(150,180,195), TC=(40,90,120), SH=(110,170,200)),   # ocean of tears / eruds crossing
}
T=THEMES[THEME]
def parse(path):
    L=[]
