...
THEMES={
 ...
 'jungle': dict(OUT=(58,72,40), INN=(110,150,60), GC=(120,124,88), TC=(70,96,44), SH=(110,150,60)),
 'swamp2': dict(OUT=(66,72,48), INN=(120,132,84), GC=(120,120,92), TC=(72,84,52), SH=(120,132,84)),    # stonebrunt
}
T=THEMES[THEME]
def parse(path):
    L=[]
