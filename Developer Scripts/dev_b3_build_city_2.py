...
THEMES={
 ...
 'desert': dict(OUT=(150,120,66), INN=(214,188,120), GC=(180,160,110), TC=(150,116,58), SH=(214,188,120)),
 'darkforest': dict(OUT=(64,60,78), INN=(120,116,140), GC=(120,118,132), TC=(72,68,88), SH=(120,116,140)),
 'plains': dict(OUT=(96,110,64), INN=(150,170,96), GC=(150,150,110), TC=(96,110,60), SH=(150,170,96)),
 'stone':  dict(OUT=(84,92,96), INN=(150,164,168), GC=(150,150,140), TC=(70,86,92), SH=(150,164,168)),
 'sewer':  dict(OUT=(70,80,54), INN=(120,140,84), GC=(120,124,100), TC=(70,84,50), SH=(120,140,84)),    # stonebrunt
}
T=THEMES[THEME]
def parse(path):
    L=[]
