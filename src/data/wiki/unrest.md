...
Succor/Evacuate:
|
-38, 52 (Zone line to Dagnor's Cauldron)
|
ZEM Value:
|
130 113 (150%)
...
Keys
|
Small Stone Key drops from a reanimated hand (unlocks magus room) Polished Brass Key drops from reclusive ghoul magus (unlocks bar room) Scuffed Silver Key drops from an undead barkeep (unlocks tower) Cracked Glass Key drops from an undead knight of Unrest (unlocks basement door)
|
|
Map
Estate of Unrest
...
Class: ALL except NEC WIZ MAG ENC
Race: ALL
(Rare), also has Tentacle Terrors who drop Tentacle WhipTentacle Whip
MAGIC ITEM
Slot: PRIMARY SECONDARY
...
Race: ALL
|
The Placeholder or the Crazed Ghoul can pop in 3 different static spots in Unrest.
Next to the ghoul magi in the bac...
|
A Dark Terror
|
Tentacle |
...
Various |
Various |
These are the lowest level creatures in Unrest. They roam the lawn and fountain area. They are not KoS despite the scowl... |
A Dry Bone Skeleton
|
Undead |
Warrior |
...
Various |
Various |
Starts with "Rune" type damage absorb. Casts Cancel Magic, Inferno Shock, Frost Shock, ~10 ds |
A Greater Dark Bone
|
Skeleton New |
Warrior |
26-30 |
2% @ (663, 99), 2% @ (637, -102), 2% @ (497, 102), 2% @ (519, 72), 2% @ (532, 53), 2% @ (677, 64) |
Various |
Bigger, badder version of the Darkbone. |
A Greater Skeleton
|
Skeleton |
Warrior |
...
Race: ALL
|
Located in an underwater passageway with Serra. |
A jack o lantern
|
Scarecrow |
Warrior |
...
Race: ALL
|
Found in the basement of Unrest. |
An Undead Brewer
|
Skeleton New |
Warrior |
...
3% @ (668, -39) 3rd floor |
Various |
Spawns behind the bar, 22 minute timer. |
...
Race: ALL
|
Uses Harm Touch and other Shadow Knight abilities. 22 minute spawn time, and has several place holders. |
Dark Boned Skeleton
|
Skeleton New |
Warrior |
15 - 19 |
34% @ (560, -63), 34% @ (662, 28), 34% @ (538, -54) |
Various |
Description needed. |
Garanel Rucksif
|
...
Warrior |
26-28 |
33% @ (661, 83), 33% @ (679, 106) |
A fungus eye, Sarcoscypha Fungus, Steel Knuckles, Amanita Phalloide |
Description needed. |
Reclusive ghoul magus
|
Ghoul |
...
Race: ALL
|
He is located in the Northwestern room on the 2nd floor, on the upper part of the balcony the spawn closest to the stair... |
Serra
|
Zombie |
unknown |
...
50% @ (688, -282) |
|
Located in an underwater passageway with a gnomish spelunker. Despawns after doll handed in, 30 Minute respawn timer... |
Shadowpincer
|
Beetle |
Warrior |
...
? |
Various |
A rare spawn found around the courtyard. Unusual behavior for an Unrest mob, KOS to druids in wolf form. |
...
Race: ALL
|
More or less a clone of Garanel Rucksif for the cleric quest. Hits much harder than his level.
He spawns floating a... |
Tormented Dead
|
Zombie |
Warrior |
10-14 |
3% @ (799, -177), 3% @ (553, 162), 3% @ (596, -288), 3% @ (375, 109) |
Various |
These common zombies roam the lawn around the manor. |
...
a greater dark bone |
(None) |
No Trade, Quest WT: 1.5 Size: SMALL Class: ALL Race: ALL |
Diablerie IIDiablerie II
WT: 0.0 Size: TINY
|
a reanimated hand |
(None) |
...
Gossamer CollarGossamer Collar
MAGIC ITEM
Slot: NECK
AC: 3
WT: 0.2 Size: SMALL
...
a festering hag |
Legs |
AC: 5 WT: 0.7 Size: MEDIUM Class: NEC WIZ MAG ENC Race: ALL |
