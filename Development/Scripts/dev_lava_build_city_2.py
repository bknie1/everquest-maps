...
THEMES={
 ...
 'lava':   dict(OUT=(92,50,28), INN=(214,92,30), GC=(158,120,96), TC=(170,64,20), SH=(214,92,30)),
 'gothic': dict(OUT=(56,52,76), INN=(150,92,178), GC=(120,120,142), TC=(96,62,124), SH=(150,92,178)),    # stonebrunt
}
T=THEMES[THEME]
def parse(path):
    L=[]
